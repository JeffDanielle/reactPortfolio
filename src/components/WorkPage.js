           ...
           <h1 className='mt-1 fw-bold'>My Works</h1>
            <Container className='mt-3 pt-5'>
                  <Row>
                     ...
                     <Col xs={10} lg={5} className='d-flex align-items-center ms-5'>
                        <div className='bg-secondary rounded'>
                         <h3 className='bg-warning rounded text-black fs-4 px-2 py-2 fw-bold'>Classroomify: A platform to gamify google classroom</h3>
                           <p className='fs-5 text-start ms-2'>A capstone project which aims to implement fun in an online classroom setting. </p>
                        </div>
                     </Col>
                  </Row>
            </Container>
                  ...
                  <Row>
                     ...
                     <Col xs={10} lg={5} className='d-flex align-items-center  ms-5'>
                        <div className='bg-secondary rounded'>
                           ...
                           <p className='fs-5 text-start ms-2'>A simple metric converter which converts a user input to length, volume, mass.</p>
                        </div>
                     </Col>
                  </Row>
            </Container>

   ...
   return (
      <section id="myworks" className="mt-5 pt-2 pb-5" >
         ...
         <Container className='mt-5 pt-5'>
            <Row>
               <Col xs={12} lg={6} className='mb-3'>
                  <Link to='https://fast-react-pizzaaa.netlify.app' target='_blank'><Image src={fastPizza} className='img-thumbnail' id='projects-img' alt='classroomify-thumbnail' /></Link>
               </Col>
               <Col xs={12} lg={5} className='d-flex align-items-center'>
                  <div className='bg-secondary rounded ms-lg-5'>
